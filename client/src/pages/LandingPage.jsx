      ...
      <section className="py-20 bg-white dark:bg-[#0B1329] border-y border-slate-100 dark:border-slate-800/80 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <h2 className="text-xs font-bold uppercase tracking-widest text-brand-600 dark:text-cyan-400 mb-2">Explore Medical Fields</h2>
            <p className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Top Specializations</p>
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-2">Connect with experienced healthcare experts across specialized disciplines.</p>
          </div>
            ...
            {steps.map((step, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-slate-50 dark:bg-[#111B33] p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800 relative"
                >
                  <span className="text-4xl font-black text-brand-200 dark:text-slate-700/60 absolute top-6 right-6 font-mono">
                    {step.num}
                  </span>
                  <div className="w-12 h-12 rounded-2xl bg-brand-600 dark:bg-cyan-600 text-white flex items-center justify-center mb-6 shadow-md shadow-brand-600/20">
