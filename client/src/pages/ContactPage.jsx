    ...
    <div className="min-h-screen bg-slate-50 pt-28 pb-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">Contact Support & Clinical Desk</h1>
          <p className="text-slate-500 text-sm">Have a question or need assistance with your booking? Our team is available 24/7.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 bg-white rounded-3xl p-8 border border-slate-200/80 shadow-xl">
          ...
          <div className="md:col-span-7 space-y-4">
            {submitted ? (
              <div className="p-8 text-center space-y-3 bg-emerald-50 rounded-2xl border border-emerald-200">
                ...
                <p className="text-xs text-slate-600">Thank you for contacting CareSync. A member of our team will respond shortly.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 rounded-xl border border-slate-200 text-xs focus:outline-none focus:border-brand-600"
                  />
                </div>
