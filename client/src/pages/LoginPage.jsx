...
import { Heart, Activity, Mail, Lock, AlertCircle, Sparkles, UserCheck, Stethoscope, Shield } from 'lucide-react';
          ...
          <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200/70 space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2 text-[11px] font-semibold">
              <button
                ...
                className="py-1.5 px-2 bg-white hover:bg-brand-50 hover:text-brand-700 text-slate-700 rounded-xl border border-slate-200 shadow-xs flex items-center justify-center gap-1 transition-all"
              >
                <UserCheck className="w-3 h-3 text-cyan-600" /> Patient
              </button>
              <button
                type="button"
                ...
                className="py-1.5 px-2 bg-white hover:bg-brand-50 hover:text-brand-700 text-slate-700 rounded-xl border border-slate-200 shadow-xs flex items-center justify-center gap-1 transition-all"
              >
                <Stethoscope className="w-3 h-3 text-brand-600" /> Doctor
              </button>
              <button
                type="button"
